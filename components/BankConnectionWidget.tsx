...
export const BankConnectionWidget = () => {
    ...
    type ConnectionState = "idle" | "selecting_bank" | "creating_session" | "connecting" | "exchanging" | "syncing" | "connected" | "error";
    ...
    if (connectionState === 'error') {
        return (
            <div className="bg-red-50 dark:bg-red-900/10 p-6 rounded-2xl border-2 border-red-200 dark:border-red-900/30 mb-8 animate-in fade-in zoom-in duration-300">
                <h3 className="text-lg font-bold text-red-600 dark:text-red-400 mb-2">Connection Failed</h3>
                <p className="text-sm text-red-500 mb-4">
                    This bank can't be linked (invalid institution or network error). Try another supported bank.
                </p>
                <button
                    type="button"
                    onClick={() => {
